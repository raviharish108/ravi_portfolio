...
export function Serv(){
    ...
    return(
      ...
      <p>Looking for a custom job?<span><a href="https://drive.google.com/file/d/1Yxmj9t-hyiccD8OEQ_McU_rILKcnZF48/view?usp=sharing" target="blank">Hire Me</a></span> to contact me! 👋</p>
      </div>
    )
}
