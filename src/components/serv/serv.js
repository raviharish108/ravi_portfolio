...
export function Serv(){
    ...
    return(
      ...
      <p>Looking for a custom job?<span><a href="https://drive.google.com/file/d/1Z_oBfAayvD8UD8QacsSDfh5aYKvg2avv/view?usp=sharing" target="blank">Hire Me</a></span> to contact me! 👋</p>
      </div>
    )
}
