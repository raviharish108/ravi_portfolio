...
export function Serv(){
    ...
    return(
      ...
      <p>Looking for a custom job?<span><a href="https://drive.google.com/file/d/1YyLX5W60frga0-S2t1TV82EcRXdSEx6e/view?usp=sharing" target="blank">Hire Me</a></span> to contact me! 👋</p>
      </div>
    )
}
