...
export function Serv(){
    ...
    return(
      ...
      <p>Looking for a custom job?<span><a href="https://drive.google.com/file/d/126-Jxuu_rZ7olzgmbIrpmIClNCeQSV2F/view" target="blank">Hire Me</a></span> to contact me! 👋</p>
      </div>
    )
}
