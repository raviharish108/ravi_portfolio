...
export function Serv(){
    ...
    return(
      ...
      <p>Looking for a custom job?<span><a href="https://drive.google.com/file/d/1ywCU3aD7GBW7_0tYkxLbs89aAsMmRC1b/view?usp=sharing" target="blank">Hire Me</a></span> to contact me! 👋</p>
      </div>
    )
}
