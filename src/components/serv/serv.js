...
export function Serv(){
    ...
    return(
      ...
      <p>Looking for a custom job?<span><a href="https://drive.google.com/file/d/18SVyqXIqXiBx0kQboJ11ntbCZTAqlTNZ/view?usp=sharing" target="blank">Hire Me</a></span> to contact me! 👋</p>
      </div>
    )
}
