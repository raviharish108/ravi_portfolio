    ...
    return(
        <div className="home_container" id="home">
            ...
            <ul>
              ...
              <Button variant="danger"><a href="https://drive.google.com/file/d/18SVyqXIqXiBx0kQboJ11ntbCZTAqlTNZ/view?usp=sharing" target="blank" className="bg-danger fw-bold">Hire Me</a></Button>
